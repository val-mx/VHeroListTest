...
public class List<E> {
  ...
  private class ListNode {
     ...
     * @param pContent das Inhaltsobjekt vom Typ ContentType
     */
    public void setContentObject(E pContent) {
      contentObject = pContent;
    }
   ...
   */
  public void concat(List<E> pList) {
